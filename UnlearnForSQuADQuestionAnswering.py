...
class ModelConfig:
    def __init__(self):
        ...
        self.unlearn_model_save_path = os.path.join(self.model_save_dir, 'unlearn_model.pt')
...
def train(config):
    ...
    if os.path.exists(config.original_model_path):
        loaded_paras = torch.load(config.original_model_path)
...
if __name__ == '__main__':
    ...
    # inference(model_config, finetuned=False)
